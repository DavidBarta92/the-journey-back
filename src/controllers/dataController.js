...
var dataController = (function(){
  ...
  let catalogue = {
    ...
    C1_craterbase2_from_enterance: require('../views/story/C1/C1_craterbase2_from_enterance.json'),
    C1_craterbase2_to_enterance: require('../views/story/C1/C1_craterbase2_to_enterance.json'),
